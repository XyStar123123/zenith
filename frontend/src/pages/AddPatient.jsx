...
function AddPatient() {
  ...
  return (
    <div className='p-6 flex flex-col gap-3 lg:ms-70'>
      <div>
        <h1 className='text-2xl font-bold'>Tambah Pasien</h1>
        <p className='text-gray-500'>Form registrasi data pasien baru</p>
      </div>
      <div className='flex flex-col gap-6 border border-gray-300 rounded-md p-6'>
        ...
        <form className='p-2' method='post' onSubmit={handleSubmit}>
          <div className='flex flex-col gap-4'>
            ...
            <input type="text" name="kode_pasien" placeholder='P001'
