...
function AppointmentAll() {
  ...
  const filteredAppointments = jadwalTemu.filter(a => {
  ...
  return (
    <div className='p-6 lg:ms-70'>
      <div className='flex flex-col gap-3 mb-5'>
        <h1 className='text-2xl font-bold'>Jadwal Temu</h1>
        <p className='text-gray-500'>Kelola jadwal pasien</p>
            ...
            <div key={app.id} className='p-6 border border-gray-300 rounded-lg flex justify-between items-center'>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span className='font-semibold'>{`${new Date(app.dibuat_pada).toLocaleDateString("id-ID", {
                    year: "numeric",
                    month: "numeric",
                    day: "numeric",
                  })}`}</span>
